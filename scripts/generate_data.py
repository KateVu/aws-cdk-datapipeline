...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Generate customer and transaction data.')
    parser.add_argument('num_customer_records', type=int, help='Number of customer records to generate')
    parser.add_argument('num_transaction_records', type=int, help='Number of transaction records to generate')
    ...
    transaction_data = generate_transaction_data(customer_ids, args.num_transaction_records)
